...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    table: ({ className, ...props }) => <div className="my-6 w-full overflow-y-auto"><table className={twMerge(clsx("w-full text-zinc-700 dark:text-zinc-300", className))} {...props} /></div>,
