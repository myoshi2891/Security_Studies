...
- **Create/Update Only**: Except for the `next typegen` validation step mentioned above, you may only create new `.mdx` files in `security-docs/src/app/docs/`. Existing documentation pages must never be overwritten or deleted.
